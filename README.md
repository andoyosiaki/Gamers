...
=======
今回初めてユーザー登録を実装させました。できれば登録ユーザー自身にユーザーアイコンをアップロードしてもらってコンテンツの表示とともにアカウント名と一緒にアイコンを表示させたかったのですが、画像のサイズの変更処理などが分からず、苦肉の策として１０種類のアイコンをこちらで用意して、ユーザーが会員登録の際に１０種類の中から好きなアイコンを選択してもらう形式にしました。
>>>>>>> 73e2972b6b8cec4c555473025badc1ff63676f40
